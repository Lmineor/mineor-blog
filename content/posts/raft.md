...
> https://developer.aliyun.com/article/941997?spm=a2c6h.13813017.content3.11.1c04323dv3RDy1
...
在图10的例子中，集群的节点数从3变成5，在某个时间点，可能有两个Leader同时被选举出来，且任期相同。一个节点拥有大部分的旧集群配置信息，而另一个节点拥有大部分的新集群配置信息。
